...
// Source of truth: rir_kernels::quant_formats() in the retroback repository
// (docs/INT_RIR.md §7.2). The same table generates the RIR registry consumed by
// rir-core, so a format cannot be known to one side and not the other.
#pragma once
