...
extern "C" {
    ...
    enum ggml_opt_loss_type {
        ...
        // retro delta: the caller supplies a scalar loss node directly
    ...
    // "which checkpoints are held longest" is what deciding what to offload
    // needs, and it survives the units it is not measured in.
    //
